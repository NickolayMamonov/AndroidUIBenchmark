package com.research.uibenchmark.bdui.utils
...
class UIComponentWrapperDeserializer : JsonDeserializer<UIComponentWrapper> {
    override fun deserialize(
        ...
        // Рекурсивно обрабатываем массив компонентов
        val components = if (jsonObject.has("components") && !jsonObject.get("components").isJsonNull) {
        ...
        val items = if (jsonObject.has("items") && !jsonObject.get("items").isJsonNull) {
