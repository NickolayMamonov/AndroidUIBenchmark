package com.research.uibenchmark.benchmark
...
object BenchmarkUtils {
    private const val TAG = "UIBenchmark"
     ...
     */
    fun calculateCodeComplexity(lines: Int, methods: Int, classes: Int): Int {
        return lines + (methods * 2) + (classes * 5)
    }
}
